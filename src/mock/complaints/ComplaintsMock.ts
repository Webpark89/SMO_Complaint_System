...
export const mockComplaints: ComplaintRow[] = [
  ...
  },
  {
    ...
    priority: "ด่วนมาก",
    location: "บริษัท กลุ่มสมอทอง จำกัด (มหาชน) ",
...
export const mockOrgData: OrgData[] = [
  { org: "บริษัท กลุ่มสมอทอง จำกัด (มหาชน) สำนักงานใหญ่ ", total: 245 },
  { org: "บริษัท กลุ่มสมอทอง จำกัด (มหาชน) สาขาท่าชนะ", total: 60 },
  { org: "บริษัท กลุ่มสมอทอง จำกัด (มหาชน) สาขาพนม", total: 45 },
  { org: "บริษัท กลุ่มสมอทอง จำกัด (มหาชน) สาขาสระบุรี", total: 55 },
];
